 ...
 * 表名：P_RIGHT<br>
 */
public class RightTable extends RecordTable {
	...
	public RightTable(Map map) {
		super(map);
	}

	static {
		RecordTable.registerTable(RightTable.class, new RecordTable.TableInfo("P_RIGHT22", "right_code"));
	}
