...
public class UserController extends BaseXhController<User> {
	...
	public String list(HttpServletRequest request, HttpServletResponse response, Model model) {
		Page<User> page = systemService.findUser(new Page<User>(request, response), getEntity());
	...
	public Page<User> listData(HttpServletRequest request, HttpServletResponse response, Model model) {
		Page<User> page = systemService.findUser(new Page<User>(request, response), getEntity());
		return page;
	}
